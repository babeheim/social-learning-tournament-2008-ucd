...
function [mean_final_strat1_pop, mean_final_strat2_pop]=rr_tournament_11(prob_of_env_change, prob_observed_wrong_act, observe_error_stdv, strategy1, strategy2)
...
number_of_simulations=1;                              %total number of simulations run between two strategies for each invasion situation
...
%%%%%%%%%%%%%%%%%%%The environment changes%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        for e=1:environment_size
            if rand < prob_of_env_change
                environment(e)=round(abs(10*randn));
            end
        end
