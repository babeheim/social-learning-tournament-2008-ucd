...
if (size(myRepertoire, 2)==1) && (size(myHistory,2) > 1) && (myHistory(2,1)~=-1) %% This is for the case where there are two indentical observations: implying population is at a maximum
